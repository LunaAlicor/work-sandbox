...
class ScreenshotTool(QMainWindow):
    ...
    def capture_full_screenshot(self):
        ...
        base_name = self.enemy_name  #+"val"
        files_in_folder = os.listdir(os.getcwd()+r"\val")
        # files_in_folder = os.listdir(os.getcwd() + r"\newdata")
        ...
        file_path = os.path.join(os.getcwd(), "newdata", file_name)
